...
from core.fitter import run_logic_approach
from api.modelslab_api import run_modelslab_inpaint_approach
    ...
    while True:
        ...
        try:
            ...
            if 0 <= choice_idx < len(example_names):
                ...
                return config.AVAILABLE_EXAMPLES[selected_example_name]
            else:
...
def main():
    ...
    # Select example
    selected_example_dir = select_example()
    ...
    while True:
        ...
        logger.info("2: ModelsLab (Inpainting)")
        ...
        if choice == '1':
            ...
            run_modelslab_inpaint_approach()
            break
        else:
